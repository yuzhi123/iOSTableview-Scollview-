...
#pragma mark --  图片 剧中切割，选定宽高比，高度比例（当高度大于宽度时，高比，小于时，宽比）
 ...
 *  @return
 */
+ (UIImage *)imageWithColor:(UIColor *)color andSize:(CGSize)size andText:(NSString*)name andFont:(UIFont*)textFont
{

    NSDictionary *fontAttributes = @{NSFontAttributeName: textFont, NSForegroundColorAttributeName: [UIColor whiteColor]};
    CGSize textSize = [name sizeWithAttributes:fontAttributes];
    ...
    [name drawAtPoint:drawPoint withAttributes:fontAttributes];
